...
<html lang="en">
  <head>
    ...
    <link rel='mask-icon' href="https://raw.githubusercontent.com/ElemeFE/element/dev/examples/assets/images/element-logo-small.svg" color="#91ca50">
    <title>控件 | Vehicle+</title>
  </head>
  <body>
    <script>
      if (!window.Promise) {
