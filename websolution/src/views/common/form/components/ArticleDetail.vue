...
import Multiselect from 'vue-multiselect'// 使用的一个多选框组件，local-element-ui的select不能满足所有需求
...
export default {
  ...
  methods: {
    fetchData() {
      service.fetchArticle().then(response => {
    ...
    getRemoteUserList(query) {
      service.userSearch(query).then(response => {
